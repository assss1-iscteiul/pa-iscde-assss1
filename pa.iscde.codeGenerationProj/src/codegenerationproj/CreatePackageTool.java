...
public class CreatePackageTool implements PidescoTool {

	public static final String CREATEPACKAGE_ID = "pa.iscde.codeGenerationProj.createPackage";

	private PackageElement packageElement = null;
	protected ProjectBrowserServices browser;

	public CreatePackageTool() {
	...
	public void run(boolean activate) {
		if (packageElement != null) {
			Thread t = new Thread(new CreatePackageDialog(packageElement));
			t.start();
			try {
				t.join();
