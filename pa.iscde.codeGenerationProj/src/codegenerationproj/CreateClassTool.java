...
public class CreateClassTool implements PidescoTool {

	public static final String CREATECLASS_ID = "pa.iscde.codeGenerationProj.createClass";

	protected PackageElement packageElement = null;
	protected ProjectBrowserServices browser;

	public CreateClassTool() {
	...
	public void run(boolean activate) {
		if (packageElement != null) {
			Thread t = new Thread(new CreateClassDialog(packageElement));
			t.start();
			try {
				t.join();
